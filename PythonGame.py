...
def path1():
    ...
    for character in s1:
        ...
        time.sleep(b)
    print()
    s2 = "...My name is Akarsh. I thought you were my sister, Kruthikka..."
    for character in s2:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(c)
    print()
    s3 = "...Ah, now I remember you! Yes, you're looking for Eeshan..."
    for character in s3:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(c)
    ...
    for character in s5:
        ...
        time.sleep(c)
    print()
    s6 = "...Only Ganesh can do that..."
    for character in s6:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(c)
    print()
    s7 = "...However, I have heard that Eeshan dwells at the base of this mountain.\""
    for character in s7:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(c)
...
def path1_1():
    ...
    for character in s1:
        ...
        time.sleep(b)
    print()
    s2 = "...My name is Krishna. I was just coming down the mountain for some fresh air..."
    for character in s2:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(c)
    print()
    s3 = "...Mount Himalayas is the highest reaching mountain on Earth and the air is specially crisp..."
    for character in s3:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(c)
...
def path1_2():
    ...
    time.sleep(a)
    s2 = '  "Finally! I can face you, Eeshan!"'
    for character in s2:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
    time.sleep(.25)
    print('--You yell, entering the base of Mount Himalayas through the largest red and black doors you\'ve ever seen')
    time.sleep(a)
...
def path2():
    ...
    for character in s1:
        ...
        time.sleep(b)
    print()
    s2 = "...My name is Kruthikka... I thought you were my brother, Akarsh..."
    for character in s2:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(c)
    ...
    for character in s6:
        ...
        time.sleep(c)
    print()
    s7 = "...However, I have heard that Eeshan dwells at the base of this cave..."
    for character in s7:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(c)
...
def path2_1():
    ...
    for character in s2:
        ...
        time.sleep(b)
    time.sleep(.25)
    print('  --You erupt as you enter the doors at the base of the cave inside Mount Himalayas')
    time.sleep(a)
    print()
...
def path2_2():
    ...
    for character in s8:
        ...
        time.sleep(c)
    print()
    s9 = "...Speak with Harshitha, help her first..."
    for character in s9:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(c)
...
def path3():
    ...
    for character in s1:
        ...
        time.sleep(b)
    print()
    s2 = "...My name is Ganesh... I'll be your guide to freedom..."
    for character in s2:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(c)
    print()
    s3 = "...Yes, I know all about you! You're looking for Eeshan..."
    for character in s3:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(c)
    ...
    for character in s5:
        ...
        time.sleep(c)
    print()
    s6 = "...However, I can transport you there, or anywhere else on Mount Himalayas..."
    for character in s6:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(c)
    print()
    s7 = "...Eeshan is just below and he'll certainly TEST YOU when you meet him."
    for character in s7:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(b)
    ...
    print()
    print()
    print("Ganesh will transport you anywhere on Mount Himalayas:")
    time.sleep(a)
    print("Path #1: Continue below to face Eeshan.")
    time.sleep(a)
    print("Path #2: Read: THE SECRETS OF TIME.")
    time.sleep(a)
    print("Path #3: Speak with Krishna.")
    time.sleep(a)
    print("Path #4: Speak with Kruthikka.")
    time.sleep(a)
    print("Path #5: Speak with Akarsh.")
    time.sleep(a)
    print()
    ...
    for character in s8:
        ...
        time.sleep(c)
    print()
    s9 = '...My name is Harshitha, I\'m in great need of help...'
    for character in s9:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(c)
    print()
    s10 = '...I know who you seek... Eeshan is just beyond this door...'
    for character in s10:
        sys.stdout.write(character)
        sys.stdout.flush()
        time.sleep(c)
    ...
    print()
    print()
    print("Path #1: Forget the old woman. Enter the doors and speak with Eeshan.")
    time.sleep(a)
    print("Path #2: Honor the woman's request. Help Harshitha return home safely.")
    time.sleep(a)
...
def path3_1():
    print()
    print('You begin walking toward the doors, ignoring Harshitha\'s request')
    time.sleep(a)
...
def path3_2():
    print()
    print('You begin walking toward Harshitha, honoring her request')
    time.sleep(a)
    ...
    print()
    time.sleep(a)
    print("You kneel down in front of Harshitha, allowing her to climb easily onto your back.")
    time.sleep(a)
